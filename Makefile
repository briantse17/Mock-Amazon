...
book.o: book.cpp book.h product.h product.cpp util.h util.cpp
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c book.cpp
clothing.o: clothing.cpp clothing.h product.cpp product.h util.cpp util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c clothing.cpp
movie.o: movie.cpp movie.h product.cpp product.h util.cpp util.h
